    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      ...
      >
        <div className="rounded-2xl border border-ink-700/50 bg-ink-900 p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border bg-ink-950 py-2.5 pl-10 pr-4 text-sm text-cream-100 placeholder:text-ink-400 focus:outline-none focus:ring-2 focus:ring-ember-500/30 ${
                    errors.name
                      ? 'border-red-500/60'
                      : 'border-ink-600'
                  }`}
          ...
          <Link
            to="/"
            className="mt-6 flex items-center justify-center gap-2 text-xs text-ink-400 hover:text-cream-200"
          >
